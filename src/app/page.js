    ...
    <div>
      ...
      <section className='h-max'>
        <div className=' flex flex-row mx-15 my-115 flex-nowrap h-96'>
          <ProductDisplay className='w-2/6' props={'./banner.png'} size={300} desc='now this is a product' />
          <ProductDisplay className='w-2/6' props={'./banner.png'} size={300} desc='now this is a product' />
      ...
      <section className='flex flex-col justify-center items-center text-black mx-20 mb-20'>
        ...
        <ProductDisplay className='w-2/6' props={'./banner.png'} size={200} desc='now this is a product' />
        <ProductDisplay className='w-2/6' props={'./banner.png'} size={200} desc='now this is a product' />
        <ProductDisplay className='w-2/6' props={'./banner.png'} size={200} desc='now this is a product' />
        <ProductDisplay className='w-2/6' props={'./banner.png'} size={200} desc='now this is a product' />
        </div>
